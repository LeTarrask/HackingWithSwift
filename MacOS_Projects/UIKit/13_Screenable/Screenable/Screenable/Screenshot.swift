...
final class Screenshot: NSObject, NSCoding {
    ...
    required init?(coder aDecoder: NSCoder) {
        caption = aDecoder.decodeObject(forKey: "caption") as!
        String
           captionFontName = aDecoder.decodeObject(forKey:
        "captionFontName") as! String
           captionFontSize = aDecoder.decodeInteger(forKey:
        "captionFontSize")
           captionColor = aDecoder.decodeObject(forKey: "captionColor")
        as! NSColor
           backgroundImage = aDecoder.decodeObject(forKey:
        "backgroundImage") as! String
           backgroundColorStart = aDecoder.decodeObject(forKey:
        "backgroundColorStart") as! NSColor
           backgroundColorEnd = aDecoder.decodeObject(forKey:
        "backgroundColorEnd") as! NSColor
           dropShadowStrength = aDecoder.decodeInteger(forKey:
        "dropShadowStrength")
           dropShadowTarget = aDecoder.decodeInteger(forKey:
        "dropShadowTarget")
    }
}
