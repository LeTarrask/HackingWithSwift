...
class GameScene: SKScene {
    ...
    override func didMove(to view: SKView) {
        ...
        // creates boundary on the frame, so the bubbles don't escape
        physicsBody = SKPhysicsBody(edgeLoopFrom: frame)
        
        // doesn't add gravity to the game
    ...
    func configurePhysics(for bubble: SKSpriteNode) {
        // configures the physics of the bubble: it's size, movement in the air, friction, etc
        ...
        // this adds motion to the bubble's physics body, and also it's velocities
